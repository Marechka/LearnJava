...
/* Pseudocode
   ...
   9. Calculate days since the beginning  of the year, while taking into consideration if it's a leap year or not       
    ...
    c) If (leapYear == true) && (nMonth >=3) add 1 more day to the total after February 
